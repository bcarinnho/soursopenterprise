                  ...
                  >
                    ...
                    <template v-slot:tbody >
                      <tbody>
                        ...
                        <td class="text-left text-xxs p-0">
                           <span class="badge " :class="m.stock>=m.stock_minimo?'badge-success':'badge-danger'"><i class="fas fa-archive" aria-hidden="true"></i> {{Number(m.stock)}} {{m.medida.codigo}} en Stock</span>
                        </td>
                        <td class="text-left text-xxs p-0">
                        ...
                        <td class="text-center text-xxs">
                          ...
                          >
                            <i
                              class="fas fa-exchange-alt text-secondary"
                              aria-hidden="true"
                            ></i>
                          </router-link>
